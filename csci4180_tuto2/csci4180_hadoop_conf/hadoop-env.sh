...
# export HADOOP_HOME="/home/ncsgroup/mi2017/hadoop-3.0.0-alpha4"
# export HADOOP_HOME="/home/ncsgroup/mi2017/hadoop-2.7.3"
...
# ZM redirect the termnial output into files
